...
public class DefaultServiceBillingController {
    ...
    private static final Logger LOG =
            LoggerFactory.getLogger(DefaultServiceBillingController.class);
    ...
    prepareDefaultServices(
        ...
        LOG.debug(
                "REST request to prepare encounter default services encounterId={} patientId={} coverageType={} itemCount={} requestId={}",
                encounterId,
                request.patientId(),
        ...
        return ResponseEntity.ok(
                defaultServicePreparationService.prepare(
                        encounterId,
                        request
                )
        );
