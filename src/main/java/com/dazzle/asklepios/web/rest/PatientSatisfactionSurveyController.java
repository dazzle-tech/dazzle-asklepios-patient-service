...
public class PatientSatisfactionSurveyController {
    ...
    @GetMapping("/patient-satisfaction-survey/responses")
    public ResponseEntity<Page<PatientSatisfactionSurveyResponseVM>> getSubmittedSurveys(
            Pageable pageable) {

        return ResponseEntity.ok(
                patientSatisfactionSurveyService.getSubmittedSurveys(pageable)
        );
    }
