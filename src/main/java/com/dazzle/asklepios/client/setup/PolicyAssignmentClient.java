...
public interface PolicyAssignmentClient {
    @GetMapping("/api/setup/policy-assignments/{id}")
    PolicyAssignmentDTO getPolicyAssignment(@PathVariable("id") @NotNull Long policyAssignmentId );
