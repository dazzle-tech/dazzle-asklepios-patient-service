...
public interface MedicationCategoryClassClient{

    @GetMapping("/api/setup/medication-categories-class/{id}")
    ResponseEntity<Void> existsMedicationCategoryClass(@PathVariable("id") @NotNull Long id );
