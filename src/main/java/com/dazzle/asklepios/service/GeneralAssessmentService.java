...
public class GeneralAssessmentService {
    ...
    private void applyUpdate(GeneralAssessment entity, GeneralAssessmentUpdateDTO generalAssessmentUpdateDTO) { if (generalAssessmentUpdateDTO.positionStatus() != null) entity.setPositionStatus(generalAssessmentUpdateDTO.positionStatus());
