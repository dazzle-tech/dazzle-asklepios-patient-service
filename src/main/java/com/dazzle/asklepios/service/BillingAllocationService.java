...
public class BillingAllocationService {
    ...
    public BigDecimal reverseActiveAllocationsForChargeLine(
            Long chargeLineId,
            String reason,
            String reversedBy,
            String requestId,
        ...
        List<BillingAllocationStatus> reversibleStatuses =
                List.of(
                        BillingAllocationStatus.ACTIVE,
                        BillingAllocationStatus.PARTIALLY_REVERSED
                );
